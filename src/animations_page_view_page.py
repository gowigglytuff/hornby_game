...
class UpdownAnimation(object):
    def __init__(self, direction):
        ...
        self.frame_action_dict = {0: {"x_speed": 0,
                                      "y_speed": -1},
                                  self.interval*1: {"x_speed": 0,
                                      "y_speed": 1},
                                  self.interval*2: {"x_speed": 0,
                                      "y_speed": -1},
                                  self.interval*3: {"x_speed": 0,
                                      "y_speed": 1}
                                  }
    ...
    #     if 0 <= self.current_frame <= 19:
    #         if Mundane.is_even(self.current_frame):
    #             self.y_change = -1
    #         else:
    #             self.y_change = 0
    #     elif 20 <= self.current_frame <= 39:
    #         if Mundane.is_even(self.current_frame):
    #             self.y_change = 1
    #         else:
    #             self.y_change = 0
    #     elif 40 <= self.current_frame <= 59:
    #         if Mundane.is_even(self.current_frame):
    #             self.y_change = -1
    #         else:
    #             self.y_change = 0
    #     elif 60 <= self.current_frame <= 79:
    #         if Mundane.is_even(self.current_frame):
    #             self.y_change = 1
    #         else:
    #             self.y_change = 0
...
class LookAroundAnimation(object):
    def __init__(self, direction):
        self.direction = direction
        self.current_frame = 0
        self.frequency = 0
